...
func NetworkCreateValidation(ctx context.Context, req *admission.Request, handler *Handler) admission.Response {
	...
	case networkingv1.NetworkTypeOverlay:
		// check uniqueness
		if exist, err := checkNetworkTypeExist(ctx, handler.Client, networkType); err != nil {
...
func checkNetworkTypeExist(ctx context.Context, client client.Reader, networkType networkingv1.NetworkType) (bool, error) {
